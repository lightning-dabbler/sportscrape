...
func (s *MLBPitchingBoxScoreScraper) Scrape(matchup interface{}) eventdata.OutputWrapper {
	start := time.Now().UTC()
...
func (s *MLBPitchingBoxScoreScraper) parsePitchingStats(responsePayload jsonresponse.MLBEventData, context eventdata.Context) ([]*model.MLBPitchingBoxScoreStats, error) {
