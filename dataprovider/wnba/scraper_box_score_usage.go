...
func (bs *BoxScoreUsageScraper) Feed() sportscrape.Feed {
	switch bs.Period {
	case Q1:
		return sportscrape.WNBAUsageBoxScoreQ1
	case Q2:
		return sportscrape.WNBAUsageBoxScoreQ2
	case Q3:
		return sportscrape.WNBAUsageBoxScoreQ3
	case Q4:
		return sportscrape.WNBAUsageBoxScoreQ4
	case H1:
		return sportscrape.WNBAUsageBoxScoreH1
	case H2:
		return sportscrape.WNBAUsageBoxScoreH2
	case AllOT:
		return sportscrape.WNBAUsageBoxScoreOT
	case Full:
		return sportscrape.WNBAUsageBoxScore
	default:
		return sportscrape.WNBAUsageBoxScore
	}
}
