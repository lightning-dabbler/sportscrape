...
func (bs *BoxScoreAdvancedScraper) Feed() sportscrape.Feed {
	switch bs.Period {
	case Q1:
		return sportscrape.WNBAAdvancedBoxScoreQ1
	case Q2:
		return sportscrape.WNBAAdvancedBoxScoreQ2
	case Q3:
		return sportscrape.WNBAAdvancedBoxScoreQ3
	case Q4:
		return sportscrape.WNBAAdvancedBoxScoreQ4
	case H1:
		return sportscrape.WNBAAdvancedBoxScoreH1
	case H2:
		return sportscrape.WNBAAdvancedBoxScoreH2
	case AllOT:
		return sportscrape.WNBAAdvancedBoxScoreOT
	case Full:
		return sportscrape.WNBAAdvancedBoxScore
	default:
		return sportscrape.WNBAAdvancedBoxScore
	}
}
