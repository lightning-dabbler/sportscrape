...
func (bs *BoxScoreTraditionalScraper) Feed() sportscrape.Feed {
	switch bs.Period {
	case Q1:
		return sportscrape.WNBATraditionalBoxScoreQ1
	case Q2:
		return sportscrape.WNBATraditionalBoxScoreQ2
	case Q3:
		return sportscrape.WNBATraditionalBoxScoreQ3
	case Q4:
		return sportscrape.WNBATraditionalBoxScoreQ4
	case H1:
		return sportscrape.WNBATraditionalBoxScoreH1
	case H2:
		return sportscrape.WNBATraditionalBoxScoreH2
	case AllOT:
		return sportscrape.WNBATraditionalBoxScoreOT
	case Full:
		return sportscrape.WNBATraditionalBoxScore
	default:
		return sportscrape.WNBATraditionalBoxScore
	}
}
