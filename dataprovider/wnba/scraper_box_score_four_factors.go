...
func (bs *BoxScoreFourFactorsScraper) Feed() sportscrape.Feed {
	switch bs.Period {
	case Q1:
		return sportscrape.WNBAFourFactorsBoxScoreQ1
	case Q2:
		return sportscrape.WNBAFourFactorsBoxScoreQ2
	case Q3:
		return sportscrape.WNBAFourFactorsBoxScoreQ3
	case Q4:
		return sportscrape.WNBAFourFactorsBoxScoreQ4
	case H1:
		return sportscrape.WNBAFourFactorsBoxScoreH1
	case H2:
		return sportscrape.WNBAFourFactorsBoxScoreH2
	case AllOT:
		return sportscrape.WNBAFourFactorsBoxScoreOT
	case Full:
		return sportscrape.WNBAFourFactorsBoxScore
	default:
		return sportscrape.WNBAFourFactorsBoxScore
	}
}
