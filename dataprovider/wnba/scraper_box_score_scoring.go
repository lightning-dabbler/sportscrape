...
func (bs *BoxScoreScoringScraper) Feed() sportscrape.Feed {
	switch bs.Period {
	case Q1:
		return sportscrape.WNBAScoringBoxScoreQ1
	case Q2:
		return sportscrape.WNBAScoringBoxScoreQ2
	case Q3:
		return sportscrape.WNBAScoringBoxScoreQ3
	case Q4:
		return sportscrape.WNBAScoringBoxScoreQ4
	case H1:
		return sportscrape.WNBAScoringBoxScoreH1
	case H2:
		return sportscrape.WNBAScoringBoxScoreH2
	case AllOT:
		return sportscrape.WNBAScoringBoxScoreOT
	case Full:
		return sportscrape.WNBAScoringBoxScore
	default:
		return sportscrape.WNBAScoringBoxScore
	}
}
