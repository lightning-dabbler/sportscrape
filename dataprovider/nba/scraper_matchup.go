...
func (ms *MatchupScraper) Scrape() sportscrape.MatchupOutput {
	...
	for _, cardData := range jsonPayload.Props.PageProps.GameCardFeed.Modules[0].Cards {
		...
		matchup := model.Matchup{
			...
			AwayScore:            cardData.CardData.AwayTeam.Score,
			HomeScore:            cardData.CardData.HomeTeam.Score,
			AwayWins:             cardData.CardData.AwayTeam.Wins,
			HomeWins:             cardData.CardData.HomeTeam.Wins,
			AwayLosses:           cardData.CardData.AwayTeam.Losses,
			HomeLosses:           cardData.CardData.HomeTeam.Losses,
