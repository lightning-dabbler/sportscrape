...
// PlayByPlayJSON - Full play by play json response (e.g. https://www.nba.com/game/chi-vs-uta-0022500240/play-by-play?period=All)
		...
		PageProps struct {
			PlayByPlay struct {
				...
				Actions []struct {
					...
					ShotDistance   float32 `json:"shotDistance"`   // "shotDistance": 5,
