...
func TestBoxScoreTrackingScraper(t *testing.T) {
	...
	assert.Equal(t, float32(4.62), testRecord.Speed)
	assert.Equal(t, float32(2.94), testRecord.Distance)
	assert.Equal(t, int32(0), testRecord.ReboundChancesOffensive)
	assert.Equal(t, int32(11), testRecord.ReboundChancesDefensive)
	assert.Equal(t, int32(11), testRecord.ReboundChancesTotal)
	assert.Equal(t, int32(95), testRecord.Touches)
	assert.Equal(t, int32(2), testRecord.SecondaryAssists)
	assert.Equal(t, int32(0), testRecord.FreeThrowAssists)
	assert.Equal(t, int32(83), testRecord.Passes)
