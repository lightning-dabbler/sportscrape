...
func (ms *MatchupScraper) Scrape() sportscrape.MatchupOutput[model.MLBMatchup] {
	var matchups []model.MLBMatchup
	output := sportscrape.MatchupOutput[model.MLBMatchup]{}
	var skips int
