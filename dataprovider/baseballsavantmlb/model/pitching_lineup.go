...
// PitchingLineup - composite key: event_id, player_id
// PitchingLineup represents the data model for the MLB pitcher lineup scraped from baseballsavant.mlb.com
type PitchingLineup struct {
	...
	// Position is the player's position name in the game's box score e.g. Pitcher
	Position string `json:"position" parquet:"name=position, type=BYTE_ARRAY, convertedtype=UTF8"`
	// LineupOrder is the 1-based position of the player within the team's pitcher lineup array as served by
