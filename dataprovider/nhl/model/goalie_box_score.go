...
type GoalieBoxScore struct {
	...
	// Player - full name from the play-by-play rosterSpots e.g. Dan Vladar (falls back to the box score name e.g. D. Vladar when the player has no first/last name there)
