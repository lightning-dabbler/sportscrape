...
func (_m *MockMatchupScraper) Feed() sportscrape.Feed {
	ret := _m.Called()
...
func (_c *MockMatchupScraper_Feed_Call) Return(_a0 sportscrape.Feed) *MockMatchupScraper_Feed_Call {
	_c.Call.Return(_a0)
	return _c
}
...
func (_m *MockMatchupScraper) Init() {
	_m.Called()
}
...
func (_m *MockMatchupScraper) Provider() sportscrape.Provider {
	ret := _m.Called()
...
func (_c *MockMatchupScraper_Provider_Call) Return(_a0 sportscrape.Provider) *MockMatchupScraper_Provider_Call {
	_c.Call.Return(_a0)
	return _c
}
...
// Scrape provides a mock function with no fields
func (_m *MockMatchupScraper) Scrape() sportscrape.MatchupOutput {
	ret := _m.Called()
	...
	if rf, ok := ret.Get(0).(func() sportscrape.MatchupOutput); ok {
		r0 = rf()
	} else {
...
func (_c *MockMatchupScraper_Scrape_Call) Return(_a0 sportscrape.MatchupOutput) *MockMatchupScraper_Scrape_Call {
	_c.Call.Return(_a0)
	return _c
}
