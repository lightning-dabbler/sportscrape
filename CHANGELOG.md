...
## [Unreleased]
### Added
- `MLBMatchupComparison` for fox sports json response for probable starting pitchers
- `MLBProbableStartingPitcher` fox sports data model for probable starting pitcher
- Scraping fox sports MLB probable starting pitcher using `MLBProbableStartingPitcherScraper`
